...
public:
    ...
    virtual float calcWeeklyPay(); // Enables derived class version to be run. Exhibits Run-Time Polymorphism
};
...
{
public:
    float calcWeeklyPay(); //calcWeeklyPay overridden to have a different implementation for Manager
};
